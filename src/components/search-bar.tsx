        ...
        <div className="w-full fixed top-0 left-0 lg:relative p-8 bg-[rgba(0,0,0,.75)] lg:bg-transparent h-[8rem] lg:px-0 lg:py-4 flex justify-between pt-8 lg:h-[6rem] items-center">
            ...
            <div className="flex gap-4" style={{ display: window.innerWidth >= 800 ? "none" : "flex" }}>
                <button
                    ...
                    className={
                        degress === "celsius" ?
                            "bg-[#6e707a] p-4 shadow rounded-full text-[#e7e7eb] text-xl font-semibold "
                            : "bg-[#6e707a] p-4 shadow rounded-full text-[#e7e7eb] text-xl font-semibold "
                    }
                >
                    °&nbsp;C
            ...
            <div className="flex items-center gap-4">
                <button className="bg-[#6e707a] lg:block hidden lg:p-2 p-4 shadow rounded-full" onClick={addToFavorites}>
                ...
                <button className="bg-[#6e707a] lg:p-2 p-4 shadow rounded-full" onClick={getCurrentLocation}>
                ...
                <button className="block lg:hidden lg:p-2 p-4 shadow rounded-full" onClick={() => toFavorite()}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-[2rem] w-[2rem] lg:w-6 lg:h-6 text-[#fef301]">
                        <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                    </svg>
                </button>
