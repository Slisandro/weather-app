            ...
            <div className="flex w-auto lg:w-full gap-8 items-center justify-between px-0 lg:px-8 mx-8 lg:mx-0 lg:px-32 overflow-x-auto lg:overflow-x-hidden overflow-y-hidden">
                {
                    current?.forecast.forecastday.slice(1, current?.forecast.forecastday.length).map((forecast, i) => (
                        <div key={forecast.date} style={{ boxShadow: "5px 5px 2px rgba(0,0,0,.5)" }} className="bg-[#1e213a] flex flex-col items-center justify-between pb-8 pt-8 mb-8 mx-4 w-[25rem] lg:w-[max-content] overflow-x-auto gap-[2rem] h-[max-content] min-w-[18rem] lg:min-w-[13rem] lg:overflow-x-auto lg:max-w-[100%] lg:gap-4">
