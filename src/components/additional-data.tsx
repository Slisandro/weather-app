...
export default function AdditionalData() {
    ...
    return (
        <div className="w-full px-4 lg:px-32 py-4 gap-6 flex flex-col lg:pb-0">
            ...
            <div className="flex flex-col gap-8 md:gap-0 mx-8 md:mx-0 md:flex-row w-auto md:w-full justify-around">
                <div style={{ boxShadow: "5px 5px 2px rgba(0,0,0,.5)" }} className="w-auto md:w-1/3 bg-[#1e213a] flex items-center justify-center flex-col p-8 lg:p-4 gap-8 md:gap-4 h-[max-content]">
                ...
                <div style={{ boxShadow: "5px 5px 2px rgba(0,0,0,.5)" }} className="w-full md:w-1/3 bg-[#1e213a] flex items-center justify-center flex-col p-8 lg:p-4 gap-8 md:gap-4 h-[max-content]">
            ...
            <div className="flex flex-col gap-8 md:gap-0 mx-8 md:mx-0 md:flex-row w-auto md:w-full justify-around">
                <div style={{ boxShadow: "5px 5px 2px rgba(0,0,0,.5)" }} className="w-auto md:w-1/3 bg-[#1e213a] flex items-center justify-center flex-col p-8 lg:p-4 gap-8 lg:gap-4">
